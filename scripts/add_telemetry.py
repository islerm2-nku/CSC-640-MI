...
def get_driver_info(session_id, telemetry_json):
    return {
        "session_id": session_id,
        "driver_user_id": telemetry_json["session_info"]["DriverInfo"]["Drivers"][0]["UserID"],
        "driver_name": telemetry_json["session_info"]["DriverInfo"]["Drivers"][0]["UserName"],
        "car_number": telemetry_json["session_info"]["DriverInfo"]["Drivers"][0]["CarNumber"],
        "car_name": telemetry_json["session_info"]["DriverInfo"]["Drivers"][0]["CarScreenName"],
